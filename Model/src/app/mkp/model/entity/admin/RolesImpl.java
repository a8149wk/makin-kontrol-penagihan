package app.mkp.model.entity.admin;
...
public class RolesImpl extends EntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("app.mkp.model.entity.admin.Roles");
        }
     ...
     */
     protected void create(AttributeList attributeList) {
             ...
             SequenceImpl seq = new SequenceImpl("ROLE_SEQ", getDBTransaction());
